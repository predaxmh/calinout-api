    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddIdentity<ApplicationUser, IdentityRole>(options =>
            {
                ...
                options.Password.RequireDigit = false;       // Simplify for testing? Set true for Prod
                options.Password.RequireUppercase = false;   // Simplify for testing?
            ...
            // 1.6 CORS (Allow Flutter App to connect)
            // just for development, then later restrict it
